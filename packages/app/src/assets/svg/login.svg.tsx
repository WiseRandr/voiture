export default function LoginSVG({ width = 25, height = 25, color = "currentColor" }) {
  return <svg version="1.1"xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 50 50" xmlSpace="preserve" width={width} height={height}>
    <path fill={color} d="M28.7,27.9c0,0,0,0.1,0,0.1c-0.1,0.2-0.5,0.5-0.7,0.6c-0.5,0.5-1.1,0.9-1.6,1.4c-0.8,0.7-1.5,1.4-2.3,2
